...
public class SemaphoreNative
{
	...
	/**
	 * Native routines should return this to signal that the routine executed without
	 * problems.
	 */
	...
	/**
	 * The semaphore operation failed because the native platform does not recognize the
	 * handle used.
	 */
	public static final int RESULT_UNKNOWN_HANDLE = 3;

	/**
	 * A value returned by the decrement method to signal that the method failed because
	 * the semaphore value was less than 1 and the specified timeout elapsed.
	 */
