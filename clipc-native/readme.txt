...
This file is part of the CLIP library.

The CLIP library is free software; you can redistribute it and/or modify it
under the terms of the Lesser GNU General Public License as published by
the Free Software Foundation; either version 2.1 of the License, or (at
your option) any later version.

The CLIP library is distributed in the hope that it will be useful, but
