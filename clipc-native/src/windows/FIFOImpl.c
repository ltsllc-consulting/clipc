...
Java_com_lts_ipc_fifo_FIFOImpl_virtualNameContainsActualNameImpl (
		JNIEnv *env,
		jclass class)
{
	jboolean result = 1;
...
openServer(JNIEnv *env, jobject this, jobject result)
{
	...
	{
		resultCode = com_lts_ipc_fifo_FIFOResult_SUCCESS;
	...
	else
	{
		switch(GetLastError())
		{
			case ERROR_NO_DATA :
			{
				resultCode = com_lts_ipc_fifo_FIFOResult_ERROR_INVALID_HANDLE;
				break;
			}

			default :
			{
				resultCode = com_lts_ipc_fifo_FIFOResult_ERROR_UNKNOWN;
				break;
			}
		}
	}
	...
	else
	{
		...
		switch(GetLastError())
		{
			case ERROR_ACCESS_DENIED :
				resultCode = (jint) com_lts_ipc_fifo_FIFOResult_ERROR_ACCESS_DENIED;
				break;

			case ERROR_PIPE_BUSY :
				resultCode = (jint) com_lts_ipc_fifo_FIFOResult_ERROR_PIPE_BUSY;
				break;

			default :
				resultCode = (jint) com_lts_ipc_fifo_FIFOResult_ERROR_UNKNOWN;
				break;
		}
	}
		...
		jobject result)
{
	...
	else
	{
		...
		{
			resultCodeValue = (jint) com_lts_ipc_fifo_FIFOResult_ERROR_ACCESS_DENIED;
		}
		else
		{
			resultCodeValue = (jint) com_lts_ipc_fifo_FIFOResult_ERROR_UNKNOWN;
		}
	}
...
{
	FIFOResult_SetErrorCode(env, result, GetLastError());
	FIFOResult_SetResultCode(env, result, (jint) com_lts_ipc_fifo_FIFOResult_ERROR_CONNECT);
...
connectNonBlockingServer(JNIEnv *env, jobject this, jobject result)
{
	...
	{
		closeNonBlockingError(env, result, com_lts_ipc_fifo_FIFOResult_ERROR_CONNECT);
		return;
	}
...
JNIEXPORT void JNICALL
Java_com_lts_ipc_fifo_FIFOImpl_connectNonBlocking (
		JNIEnv *env,
		jobject this,
		jobject result)
{
...
JNIEXPORT void JNICALL
Java_com_lts_ipc_fifo_FIFOImpl_createNonBlocking (
		JNIEnv *env,
		jclass class,
		jobject result,
		jstring name)
		...
		DWORD timeoutMsec)
{
	...
	{
		FIFOResult_SetResultCode(env, result, com_lts_ipc_fifo_FIFOResult_ERROR_READ);
		FIFOResult_SetErrorCode(env, result, GetLastError());
		return;
	}
...
JNIEXPORT void JNICALL
Java_com_lts_ipc_fifo_FIFOImpl_readNonBlocking (
		JNIEnv *env,
		jobject this,
		jobject result,
		jbyteArray buffer,
...
JNIEXPORT void JNICALL
Java_com_lts_ipc_fifo_FIFOImpl_writeNonBlocking (
		JNIEnv *env,
		jobject this,
		jobject result,
		jbyteArray buffer,
