...
public class RadioButtonMenuItem extends MenuItemSpec
{
	final static public String STR_RADIO = "radio";
	...
	{
		if (clazz == String.class && ((String) o).equalsIgnoreCase(STR_RADIO))
		{
			;
		}
		else 
