...
public class FIFOChatterbox implements Server
{
	public static final String FIFO_NAME = "chatterboxFIFO";
	
	private static FIFOChatterbox ourInstance;
	
	
	public FIFOChatterbox()
	{
		initialize();
	}
	...
	public static FIFOChatterbox getInstance()
	{
		if (null == ourInstance)
			ourInstance = new FIFOChatterbox();
	...
	public void launch() 
	{
		...
		{
			String[][] spawnClasses = {
				{ FIFOApplication.class.getName(), "Reader" },
				{ FIFOApplication.class.getName(), "Writer" },
			};
